...
class TestUserAuth:
    ...
    def setup(self):
        ...
        assert "user_id" in response1.json(), "There is nouser id in the response"
    ...
    def test_user_auth(self):
        ...
        assert self.user_id_from_auth_metod == user_id_from_chek_method, "User idfrom auth method is not equal to user id from check method"
